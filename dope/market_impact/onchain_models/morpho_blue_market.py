...
class MorphoBlueMarket:
    def __init__(self, fee: int, last_update: int, total_borrow_assets: int, total_borrow_shares: int,
                 total_supply_assets: int, total_supply_shares: int):
        self.fee = fee
...
class MorphoBlueMarketMarket:
    def __init__(self, morpho_blue_market_params: MorphoBlueMarketParams, morpho_blue_market: MorphoBlueMarket,
                 current_timestamp: int, rate_at_target: int):
    ...
    def _curve(self, _rate_at_target: int, err: int) -> int:
        coeff = ONE_18_DEC - self._w_div_to_zero(ONE_18_DEC,
                                                 CURVE_STEEPNESS) if err < 0 else CURVE_STEEPNESS - ONE_18_DEC
