...
class CompoundV3Market:
  ...
  def calculate_compound_v3_supply_rate(self, utilization_rate: int) -> int:
    if utilization_rate <= self.supply_kink:
      ...
      return (excess_utilization_rate * self.supply_per_second_interest_rate_slope_high // (10 ** 18)) + normal_rate
  ...
  def rates(self) -> Rates:
    ...
    return CompoundV3Rates(supply_rate, borrow_rate)


def test():
  market = CompoundV3Market(total_borrows=454299260393634,
                            total_supply=560241660778185,
                            supply_per_second_interest_rate_base=0,
                            supply_kink=900000000000000000,
                            supply_per_second_interest_rate_slope_low=2378234398,
                            supply_per_second_interest_rate_slope_high=114155251141,
                            borrow_per_second_interest_rate_base=475646879,
                            borrow_kink=900000000000000000,
