class CompoundMarket:
    ...
    def __init__(self, exchange_rate_stored, total_borrows, total_supply, total_reserves, reserve_factor_mantissa,
                 multiplier_per_block, base_rate_per_block, kink, jump_multiplier_per_block):
    ...
    def rates(self):
        ...
        return Rates(liquidity_rate, borrow_rate)
...
def test():
    ...
    market = CompoundMarket(exchange_rate_stored, total_borrows, total_supply, total_reserves, reserve_factor_mantissa,
                            multiplier_per_block, base_rate_per_block, kink, jump_multiplier_per_block)
